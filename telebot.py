...
TOKEN = '6943652930:AAHVRjHkZmsPcRUk2QF74Vlp2W1Q_gZ7U9c'
...
try:
    ...
    if os.name == 'posix':
        background_cmd = f'nohup python3 "{__file__}" > /dev/null 2>&1 &'
    elif os.name == 'nt':
        background_cmd = f'start /B pythonw "{__file__}"'

    # Run the script in the background
    subprocess.Popen(background_cmd, shell=True)
